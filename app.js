async function loadInternetOrders() {
  ...
  try {
    // Raporlardaki gibi önce veriyi direkt ve hatasız çekelim, tablo anında dolsun
    ...
    if (!orders || orders.length === 0) {
      tbody.innerHTML = '<tr><td colspan="6" style="text-align:center; color:#94a3b8; padding:20px;">Bu aralıkta internet siparişi bulunamadı.</td></tr>';
      return;
    }
    ...
    tbody.innerHTML = `<tr><td colspan="6" style="text-align:center; color:#dc2626; padding:20px;">Hata oluştu.</td></tr>`;
  }
}
